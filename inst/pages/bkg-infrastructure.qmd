...
# needed for `r BiocStyle::Biocpkg("<package_name>") etc.
...
A summary of the `SpatialExperiment` object structure is shown in the @fig-spe. 
...
![Overview of the `SpatialExperiment` data class for storing and manipulating spatial transcriptomics datasets within the Bioconductor framework.](../images/SpatialExperiment.png){#fig-spe}

<!-- # ```{r spe, echo = FALSE, out.width = "80%", fig.cap = "Overview of the `SpatialExperiment` data class for storing and manipulating spatial transcriptomics datasets within the Bioconductor framework."} -->
...
`r BiocStyle::Biocpkg("MoleculeExperiment")` (ME) [@PetersCouto2023] is designed to imaging-based spatial transcriptomics data.
...
![Overview of the `SpatialExperiment` data class for storing and manipulating spatial transcriptomics datasets within the Bioconductor framework.](../images/SpatialData.png){#fig-spd}

<!-- # ```{r spd, echo = FALSE, out.width = "80%", fig.cap = "Overview of the scverse/Python `SpatialData` framework."} -->
